...
int main (){
    // Abrimos el archivo .OBJ en modo de lectura
    ...
    // Declaramos dos caras
    int vertex1, vertex2;
    float xp1, yp1, xp2, yp2;
 
    // Ejecutar los algoritmos para trazar la linea
    //int i = 0, j = 0;
    ...
    printf("\nThe proccess is complete, now you can see your image\n");
